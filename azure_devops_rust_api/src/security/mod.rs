  ...
  pub mod set_access_control_entries {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::AccessControlEntryList> {
        ...
        let body: models::AccessControlEntryList = serde_json::from_slice(&bytes).map_err(|e| {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::AccessControlEntryList>>;
  ...
  pub mod query {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::AccessControlListList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::AccessControlListList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::AccessControlListList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
...
pub mod permissions {
  ...
  pub mod has_permissions {
    ...
    impl RequestBuilder {
      ...
      pub fn always_allow_administrators(mut self, always_allow_administrators: bool) -> Self {
  ...
  pub mod remove_permission {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::AccessControlEntry> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::AccessControlEntry = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod has_permissions_batch {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::PermissionEvaluationBatch> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::PermissionEvaluationBatch =
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::PermissionEvaluationBatch>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
...
pub mod security_namespaces {
  ...
  pub mod query {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::SecurityNamespaceDescriptionList> {
        let bytes = self.0.into_body().collect().await?;
