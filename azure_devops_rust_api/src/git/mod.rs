...
impl Client {
  ...
  pub fn pull_request_iteration_statuses_client(&self) -> pull_request_iteration_statuses::Client {
  ...
  pub mod get_deleted_repositories {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::GitDeletedRepositoryList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::GitDeletedRepositoryList =
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::GitDeletedRepositoryList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::GitRepositoryList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::GitRepositoryList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
...
pub mod commits {
  ...
  pub mod get_commits {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::GitCommitRefList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::GitCommitRefList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
    ...
    impl RequestBuilder {
      ...
      pub fn search_criteria_author(mut self, search_criteria_author: impl Into<String>) -> Self {
      ...
      pub fn search_criteria_include_links(mut self, search_criteria_include_links: bool) -> Self {
      ...
      pub fn search_criteria_include_user_image_url(
        ...
        self.search_criteria_include_user_image_url = Some(search_criteria_include_user_image_url);
        self
      }
      ...
      pub fn search_criteria_to_date(mut self, search_criteria_to_date: impl Into<String>) -> Self {
      ...
      pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
        Box::pin({
          ...
          async move {
            ...
            if let Some(search_criteria_exclude_deletes) = &this.search_criteria_exclude_deletes {
              req.url_mut().query_pairs_mut().append_pair(
                "searchCriteria.excludeDeletes",
                &search_criteria_exclude_deletes.to_string(),
              );
            }
            if let Some(search_criteria_from_commit_id) = &this.search_criteria_from_commit_id {
              req.url_mut().query_pairs_mut().append_pair(
            ...
            if let Some(search_criteria_history_mode) = &this.search_criteria_history_mode {
              req
                .url_mut()
                .query_pairs_mut()
                .append_pair("searchCriteria.historyMode", search_criteria_history_mode);
            }
            if let Some(search_criteria_include_links) = &this.search_criteria_include_links {
              req.url_mut().query_pairs_mut().append_pair(
                "searchCriteria.includeLinks",
                &search_criteria_include_links.to_string(),
              );
            }
            if let Some(search_criteria_include_push_data) = &this.search_criteria_include_push_data
            {
              req.url_mut().query_pairs_mut().append_pair(
            ...
            if let Some(search_criteria_to_commit_id) = &this.search_criteria_to_commit_id {
              req
                .url_mut()
                .query_pairs_mut()
  ...
  pub mod get {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::GitCommit>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod get_changes {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::GitCommitChanges> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::GitCommitChanges = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod get {
    ...
    impl RequestBuilder {
      ...
      pub fn version_descriptor_version_options(
        ...
        self.version_descriptor_version_options = Some(version_descriptor_version_options.into());
        self
      }
      #[doc = "Version type (branch, tag, or commit). Determines how Id is interpreted"]
      ...
      pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
        Box::pin({
          ...
          async move {
            ...
            if let Some(version_descriptor_version_type) = &this.version_descriptor_version_type {
              req.url_mut().query_pairs_mut().append_pair(
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::GitItem>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
      ...
      pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
        Box::pin({
          ...
          async move {
            ...
            if let Some(base_version_descriptor_version) = &this.base_version_descriptor_version {
              req.url_mut().query_pairs_mut().append_pair(
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::GitBranchStatsList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::GitBranchStatsList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::GitRefFavoriteList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::GitRefFavoriteList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod get {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::PolicyConfigurationList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::PolicyConfigurationList =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::PolicyConfigurationList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod get_pull_requests_by_project {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::GitPullRequestList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::GitPullRequestList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
    ...
    impl RequestBuilder {
      ...
      pub fn search_criteria_status(mut self, search_criteria_status: impl Into<String>) -> Self {
      ...
      pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
        Box::pin({
          ...
          async move {
            ...
            if let Some(search_criteria_repository_id) = &this.search_criteria_repository_id {
              req
                .url_mut()
                .query_pairs_mut()
                .append_pair("searchCriteria.repositoryId", search_criteria_repository_id);
            }
            ...
            if let Some(search_criteria_source_ref_name) = &this.search_criteria_source_ref_name {
              req.url_mut().query_pairs_mut().append_pair(
            ...
            if let Some(search_criteria_target_ref_name) = &this.search_criteria_target_ref_name {
              req.url_mut().query_pairs_mut().append_pair(
          ...
          async move {
            ...
            if let Some(include_work_item_refs) = &this.include_work_item_refs {
              req
                .url_mut()
                .query_pairs_mut()
                .append_pair("includeWorkItemRefs", &include_work_item_refs.to_string());
            }
            let req_body = azure_core::EMPTY_BODY;
            req.set_body(req_body);
            Ok(Response(this.client.send(&mut req).await?))
  ...
  pub mod create {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::GitAnnotatedTag> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::GitAnnotatedTag = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
...
pub mod blobs {
  ...
  pub mod get_blob {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::GitBlobRef>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
...
pub mod statuses {
  ...
  pub mod create {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::GitStatus>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
...
pub mod diffs {
  ...
  pub mod get {
    ...
    impl RequestBuilder {
      ...
      #[doc = "Version options - Specify additional modifiers to version (e.g Previous)"]
      pub fn target_version_options(mut self, target_version_options: impl Into<String>) -> Self {
  ...
  pub mod query {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::GitImportRequestList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::GitImportRequestList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod create {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::GitImportRequest> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::GitImportRequest = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod get {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::GitPullRequestQuery> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::GitPullRequestQuery = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
...
pub mod pull_request_attachments {
  ...
  pub mod create {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::Attachment>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
...
pub mod pull_request_iterations {
  ...
  pub mod list {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::GitPullRequestIterationList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::GitPullRequestIterationList =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
  ...
  pub mod get {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::GitPullRequestIteration> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::GitPullRequestIteration =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::GitPullRequestIteration>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
...
pub mod pull_request_iteration_changes {
  ...
  pub mod get {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::GitPullRequestIterationChanges> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::GitPullRequestIterationChanges =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::GitPullRequestStatusList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::GitPullRequestStatusList =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::GitPullRequestStatusList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod create {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::GitPullRequestStatus> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::GitPullRequestStatus = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::WebApiTagDefinitionList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::WebApiTagDefinitionList =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::WebApiTagDefinitionList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod create {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::WebApiTagDefinition> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::WebApiTagDefinition = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::PropertiesCollection> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::PropertiesCollection = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::IdentityRefWithVoteList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::IdentityRefWithVoteList =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::IdentityRefWithVoteList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod create_unmaterialized_pull_request_reviewer {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::IdentityRefWithVote> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::IdentityRefWithVote = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
...
pub mod pull_request_threads {
  ...
  pub mod list {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::GitPullRequestCommentThreadList> {
        let bytes = self.0.into_body().collect().await?;
  ...
  pub mod create {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::GitPullRequestCommentThread> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::GitPullRequestCommentThread =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
...
pub mod pull_request_thread_comments {
  ...
  pub mod create {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::Comment>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::IdentityRefList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::IdentityRefList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
    ...
    impl RequestBuilder {
      ...
      pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
        Box::pin({
          ...
          async move {
            let url = azure_core::Url::parse(&format!(
              "{}/{}/{}/_apis/git/repositories/{}/pullRequests/{}/threads/{}/comments/{}/likes",
              this.client.endpoint(),
              &this.organization,
              &this.project,
              &this.repository_id,
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::ResourceRefList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::ResourceRefList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
...
pub mod pushes {
  ...
  pub mod list {
    ...
    impl RequestBuilder {
      ...
      pub fn search_criteria_include_ref_updates(
        ...
        self.search_criteria_include_ref_updates = Some(search_criteria_include_ref_updates);
        self
      }
      #[doc = "Search criteria attributes: fromDate, toDate, pusherId, refName, includeRefUpdates or includeLinks. fromDate: Start date to search from. toDate: End date to search to. pusherId: Identity of the person who submitted the push. refName: Branch name to consider. includeRefUpdates: If true, include the list of refs that were updated by the push. includeLinks: Whether to include the _links field on the shallow references."]
  ...
  pub mod create {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::GitPush>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
...
pub mod refs {
  ...
  pub mod list {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::GitRefList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod update_refs {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::GitRefUpdateResultList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::GitRefUpdateResultList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::GitRefUpdateResultList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod update_ref {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::GitRef>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
...
pub mod reverts {
  ...
  pub mod get_revert_for_ref_name {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::GitRevert>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::GitSuggestionList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::GitSuggestionList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
...
pub mod trees {
  ...
  pub mod get {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::GitTreeRef>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::GitRepositoryRefList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::GitRepositoryRefList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod get_fork_sync_requests {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::GitForkSyncRequestList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::GitForkSyncRequestList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::GitForkSyncRequestList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod create_fork_sync_request {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::GitForkSyncRequest> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::GitForkSyncRequest = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
...
pub mod merges {
  ...
  pub mod create {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::GitMerge>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
