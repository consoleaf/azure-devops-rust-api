    ...
    impl RequestBuilder {
      ...
      pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
        Box::pin({
          ...
          async move {
            let url = azure_core::Url::parse(&format!(
              "{}/{}/{}/_apis/build/builds/{}/artifacts?artifactName={}&fileId={}&fileName={}",
              this.client.endpoint(),
              &this.organization,
              &this.project,
              &this.build_id,
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::BuildArtifactList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::BuildArtifactList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod get_retention_leases_by_user_id {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::RetentionLeaseList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::RetentionLeaseList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
...
pub mod controllers {
  ...
  impl Client {
    ...
    #[doc = "Arguments:"]
    #[doc = "* `organization`: The name of the Azure DevOps organization."]
    pub fn get(&self, organization: impl Into<String>, controller_id: i32) -> get::RequestBuilder {
      get::RequestBuilder {
        client: self.0.clone(),
        organization: organization.into(),
        controller_id,
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::BuildControllerList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::BuildControllerList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod get {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::BuildController> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::BuildController = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod get {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::BuildResourceUsage> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::BuildResourceUsage = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod get {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::BuildRetentionHistory> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::BuildRetentionHistory = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::BuildRetentionHistory>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
...
pub mod authorizedresources {
  ...
  pub mod list {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::DefinitionResourceReferenceList> {
        let bytes = self.0.into_body().collect().await?;
...
pub mod builds {
  ...
  pub mod list {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::BuildList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod get_build_changes {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::ChangeList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod get {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::BuildReportMetadata> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::BuildReportMetadata = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
...
pub mod timeline {
  ...
  pub mod get {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::Timeline>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
...
pub mod definitions {
  ...
  pub mod list {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::BuildDefinitionReferenceList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::BuildDefinitionReferenceList =
    ...
    impl RequestBuilder {
      ...
      pub fn min_metrics_time(mut self, min_metrics_time: impl Into<time::OffsetDateTime>) -> Self {
      ...
      pub fn not_built_after(mut self, not_built_after: impl Into<time::OffsetDateTime>) -> Self {
      ...
      #[doc = "If specified, filters to YAML definitions that match the given filename."]
        ...
        Box::pin({
          ...
          async move {
            ...
            if let Some(min_metrics_time) = &this.min_metrics_time {
              let formatted_date_time = crate::date_time::format_date_time(min_metrics_time)?;
              req
                .url_mut()
                .query_pairs_mut()
            ...
            if let Some(built_after) = &this.built_after {
              let formatted_date_time = crate::date_time::format_date_time(built_after)?;
              req
                .url_mut()
                .query_pairs_mut()
            ...
            if let Some(not_built_after) = &this.not_built_after {
              let formatted_date_time = crate::date_time::format_date_time(not_built_after)?;
              req
                .url_mut()
                .query_pairs_mut()
            ...
            if let Some(include_all_properties) = &this.include_all_properties {
              req
                .url_mut()
                .query_pairs_mut()
                .append_pair("includeAllProperties", &include_all_properties.to_string());
            }
  ...
  pub mod create {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::BuildDefinition> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::BuildDefinition = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
    ...
    impl RequestBuilder {
      ...
      pub fn definition_to_clone_revision(mut self, definition_to_clone_revision: i32) -> Self {
          ...
          async move {
            ...
            if let Some(definition_to_clone_id) = &this.definition_to_clone_id {
              req
                .url_mut()
                .query_pairs_mut()
                .append_pair("definitionToCloneId", &definition_to_clone_id.to_string());
            }
            if let Some(definition_to_clone_revision) = &this.definition_to_clone_revision {
              req.url_mut().query_pairs_mut().append_pair(
  ...
  pub mod update {
    ...
    impl RequestBuilder {
      pub fn secrets_source_definition_id(mut self, secrets_source_definition_id: i32) -> Self {
      ...
      pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
        Box::pin({
          ...
          async move {
            ...
            req.insert_header("content-type", "application/json");
            let req_body = azure_core::to_json(&this.body)?;
            if let Some(secrets_source_definition_id) = &this.secrets_source_definition_id {
              req.url_mut().query_pairs_mut().append_pair(
  ...
  pub mod get_definition_revisions {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::BuildDefinitionRevisionList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::BuildDefinitionRevisionList =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
  ...
  pub mod get_definition_metrics {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::BuildMetricList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::BuildMetricList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
...
pub mod yaml {
  ...
  pub mod get {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::YamlBuild>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
...
pub mod templates {
  ...
  pub mod list {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::BuildDefinitionTemplateList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::BuildDefinitionTemplateList =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
  ...
  pub mod get {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::BuildDefinitionTemplate> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::BuildDefinitionTemplate =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::BuildDefinitionTemplate>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
...
pub mod folders {
  ...
  pub mod update {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::Folder>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod list {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::FolderList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod get {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::PipelineGeneralSettings> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::PipelineGeneralSettings =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::PipelineGeneralSettings>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::BuildOptionDefinitionList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::BuildOptionDefinitionList =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::BuildOptionDefinitionList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod get {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::ProjectRetentionSetting> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::ProjectRetentionSetting =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::ProjectRetentionSetting>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
...
pub mod source_providers {
  ...
  pub mod list {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::SourceProviderAttributesList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::SourceProviderAttributesList =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
  ...
  pub mod get_path_contents {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::SourceRepositoryItemList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::SourceRepositoryItemList =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::SourceRepositoryItemList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod list_repositories {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::SourceRepositories> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::SourceRepositories = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod list_webhooks {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::RepositoryWebhookList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::RepositoryWebhookList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::RepositoryWebhookList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
