...
pub mod pipeline_permissions {
  ...
  pub mod update_pipeline_permisions_for_resources {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::ResourcePipelinePermissionsList> {
  ...
  pub mod get {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::ResourcePipelinePermissions> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::ResourcePipelinePermissions =
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::CheckConfigurationList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::CheckConfigurationList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::CheckConfigurationList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod add {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::CheckConfiguration> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::CheckConfiguration = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
...
pub mod check_evaluations {
  ...
  pub mod evaluate {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::CheckSuite>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
