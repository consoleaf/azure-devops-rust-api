  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::TeamProjectReferenceList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::TeamProjectReferenceList =
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::TeamProjectReferenceList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod get_project_properties {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::ProjectPropertyList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::ProjectPropertyList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
...
pub mod teams {
  ...
  impl Client {
    ...
    #[doc = "Arguments:"]
    #[doc = "* `organization`: The name of the Azure DevOps organization."]
    pub fn get_all_teams(&self, organization: impl Into<String>) -> get_all_teams::RequestBuilder {
  ...
  pub mod create {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::WebApiTeam>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
