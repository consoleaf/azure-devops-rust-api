...
pub mod pools {
  ...
  impl Client {
    ...
    pub fn delete(&self, organization: impl Into<String>, pool_id: i32) -> delete::RequestBuilder {
  ...
  pub mod get_agent_pools {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::TaskAgentPoolList> {
        ...
        let body: models::TaskAgentPoolList = serde_json::from_slice(&bytes).map_err(|e| {
  ...
  pub mod get_agent_queues_by_names {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::TaskAgentQueueList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::TaskAgentQueueList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod get_variable_groups {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::VariableGroupList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::VariableGroupList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
...
pub mod agentclouds {
  ...
  impl Client {
    ...
    #[doc = "Arguments:"]
    #[doc = "* `organization`: The name of the Azure DevOps organization."]
    pub fn get(&self, organization: impl Into<String>, agent_cloud_id: i32) -> get::RequestBuilder {
      get::RequestBuilder {
        client: self.0.clone(),
        organization: organization.into(),
        agent_cloud_id,
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::TaskAgentCloudList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::TaskAgentCloudList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::TaskAgentCloudRequestList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::TaskAgentCloudRequestList =
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::TaskAgentCloudRequestList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::TaskAgentCloudTypeList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::TaskAgentCloudTypeList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::TaskAgentCloudTypeList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
...
pub mod agents {
      ...
      pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
        Box::pin({
          ...
          async move {
            ...
            if let Some(include_last_completed_request) = &this.include_last_completed_request {
              req.url_mut().query_pairs_mut().append_pair(
  ...
  pub mod add {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::TaskAgent>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::DeploymentGroupList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::DeploymentGroupList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod add {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::DeploymentGroup> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::DeploymentGroup = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::DeploymentMachineList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::DeploymentMachineList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::DeploymentMachineList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod get {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::DeploymentMachine> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::DeploymentMachine = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::EnvironmentInstanceList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::EnvironmentInstanceList =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::EnvironmentInstanceList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod add {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::EnvironmentInstance> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::EnvironmentInstance = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(
        ...
        let bytes = self.0.into_body().collect().await?;
        let body: models::EnvironmentDeploymentExecutionRecordList = serde_json::from_slice(&bytes)
          .map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
  ...
  pub mod add {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::KubernetesResource> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::KubernetesResource = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
...
pub mod taskgroups {
  ...
  pub mod add {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::TaskGroup>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
      ...
      pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
        Box::pin({
          ...
          async move {
            ...
            if let Some(continuation_token) = &this.continuation_token {
              let formatted_date_time = crate::date_time::format_date_time(continuation_token)?;
              req
                .url_mut()
                .query_pairs_mut()
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::ElasticPoolList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::ElasticPoolList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod create {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::ElasticPoolCreationResult> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::ElasticPoolCreationResult =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
    ...
    impl RequestBuilder {
      ...
      pub fn auto_provision_project_pools(mut self, auto_provision_project_pools: bool) -> Self {
      ...
      pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
        Box::pin({
          ...
          async move {
            ...
            if let Some(auto_provision_project_pools) = &this.auto_provision_project_pools {
              req.url_mut().query_pairs_mut().append_pair(
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::ElasticPoolCreationResult>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::ElasticPoolLogList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::ElasticPoolLogList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::ElasticNodeList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::ElasticNodeList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
