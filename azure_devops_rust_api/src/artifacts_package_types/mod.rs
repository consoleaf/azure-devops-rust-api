...
pub mod maven {
  ...
  pub mod get_upstreaming_behavior {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::UpstreamingBehavior> {
        ...
        let body: models::UpstreamingBehavior = serde_json::from_slice(&bytes).map_err(|e| {
  ...
  pub mod get_package_version_from_recycle_bin {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::MavenPackageVersionDeletionState> {
        let bytes = self.0.into_body().collect().await?;
...
pub mod npm {
  ...
  pub mod get_scoped_package_version_from_recycle_bin {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::NpmPackageVersionDeletionState> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::NpmPackageVersionDeletionState =
...
pub mod nu_get {
  ...
  pub mod download_package {
    ...
    impl RequestBuilder {
      #[doc = "Unused"]
      pub fn source_protocol_version(mut self, source_protocol_version: impl Into<String>) -> Self {
  ...
  pub mod get_package_version_from_recycle_bin {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::NuGetPackageVersionDeletionState> {
        let bytes = self.0.into_body().collect().await?;
...
pub mod python {
  ...
  pub mod get_package_version_from_recycle_bin {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::PyPiPackageVersionDeletionState> {
        let bytes = self.0.into_body().collect().await?;
...
pub mod universal {
  ...
  pub mod get_package_version_from_recycle_bin {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::UPackPackageVersionDeletionState> {
        let bytes = self.0.into_body().collect().await?;
