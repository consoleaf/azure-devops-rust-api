  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::TfvcShelvesetRefList> {
        ...
        let body: models::TfvcShelvesetRefList = serde_json::from_slice(&bytes).map_err(|e| {
    ...
    impl RequestBuilder {
      ...
      pub fn request_data_include_details(mut self, request_data_include_details: bool) -> Self {
      ...
      pub fn request_data_max_change_count(mut self, request_data_max_change_count: i32) -> Self {
      ...
      pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
        Box::pin({
          ...
          async move {
            ...
            if let Some(request_data_include_details) = &this.request_data_include_details {
            ...
            if let Some(request_data_include_work_items) = &this.request_data_include_work_items {
              req.url_mut().query_pairs_mut().append_pair(
                "requestData.includeWorkItems",
                &request_data_include_work_items.to_string(),
              );
            }
            if let Some(request_data_max_change_count) = &this.request_data_max_change_count {
              req.url_mut().query_pairs_mut().append_pair(
                "requestData.maxChangeCount",
                &request_data_max_change_count.to_string(),
              );
            }
            if let Some(request_data_max_comment_length) = &this.request_data_max_comment_length {
              req.url_mut().query_pairs_mut().append_pair(
  ...
  pub mod get_shelveset_work_items {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::AssociatedWorkItemList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::AssociatedWorkItemList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::AssociatedWorkItemList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
...
pub mod branches {
  ...
  pub mod get {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::TfvcBranch>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod get_branch_refs {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::TfvcBranchRefList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::TfvcBranchRefList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod get {
    ...
    impl RequestBuilder {
      ...
      pub fn version_descriptor_version_option(
        ...
        self.version_descriptor_version_option = Some(version_descriptor_version_option.into());
        self
      }
      #[doc = "Version descriptor.  Default is null."]
      ...
      pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
        Box::pin({
          ...
          async move {
            ...
            if let Some(version_descriptor_version_option) = &this.version_descriptor_version_option
            {
              req.url_mut().query_pairs_mut().append_pair(
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::TfvcItem>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod get_batched_changesets {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::TfvcChangesetRefList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::TfvcChangesetRefList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
      ...
      pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
        Box::pin({
          ...
          async move {
            ...
            if let Some(search_criteria_follow_renames) = &this.search_criteria_follow_renames {
              req.url_mut().query_pairs_mut().append_pair(
  ...
  pub mod create {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::TfvcChangesetRef> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::TfvcChangesetRef = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
...
pub mod labels {
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::TfvcLabelRefList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::TfvcLabelRefList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
      ...
      pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
        Box::pin({
          ...
          async move {
            ...
            if let Some(request_data_item_label_filter) = &this.request_data_item_label_filter {
              req.url_mut().query_pairs_mut().append_pair(
  ...
  pub mod get {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::TfvcLabel>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
