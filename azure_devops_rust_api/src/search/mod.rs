...
pub mod package_search_results {
  ...
  pub mod fetch_package_search_results {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::PackageSearchResponseContent> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::PackageSearchResponseContent =
  ...
  pub mod fetch_code_search_results {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::CodeSearchResponse> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::CodeSearchResponse = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod get {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::RepositoryStatusResponse> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::RepositoryStatusResponse =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::RepositoryStatusResponse>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
...
pub mod tfvc {
  ...
  pub mod get {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::TfvcRepositoryStatusResponse> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::TfvcRepositoryStatusResponse =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
  ...
  pub mod fetch_wiki_search_results {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::WikiSearchResponse> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::WikiSearchResponse = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod fetch_work_item_search_results {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::WorkItemSearchResponse> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::WorkItemSearchResponse = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::WorkItemSearchResponse>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
