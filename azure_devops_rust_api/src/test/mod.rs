      ...
      pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
        Box::pin({
          ...
          async move {
            ...
            let formatted_date_time = crate::date_time::format_date_time(min_last_updated_date)?;
            req
              .url_mut()
              .query_pairs_mut()
              .append_pair("minLastUpdatedDate", &formatted_date_time);
            let max_last_updated_date = &this.max_last_updated_date;
            let formatted_date_time = crate::date_time::format_date_time(max_last_updated_date)?;
            req
              .url_mut()
              .query_pairs_mut()
  ...
  pub mod get_test_run_statistics {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::TestRunStatistic> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::TestRunStatistic = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod get_test_sub_result_attachments {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::TestAttachmentList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::TestAttachmentList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod create_test_sub_result_attachment {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::TestAttachmentReference> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::TestAttachmentReference =
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::TestAttachmentReference>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod get_build_code_coverage {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::BuildCoverageList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::BuildCoverageList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod get_test_run_code_coverage {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::TestRunCoverageList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::TestRunCoverageList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
...
pub mod points {
  ...
  pub mod get_point {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::TestPoint>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod get_points_by_query {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::TestPointsQuery> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::TestPointsQuery = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::SuiteTestCaseList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::SuiteTestCaseList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod get {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::ResultRetentionSettings> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::ResultRetentionSettings =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::ResultRetentionSettings>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod query {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::TestHistoryQuery> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::TestHistoryQuery = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::TestCaseResultList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::TestCaseResultList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
...
pub mod iterations {
  ...
  pub mod list {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::TestIterationDetailsModelList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::TestIterationDetailsModelList =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
          ...
          async move {
            ...
            if let Some(include_action_results) = &this.include_action_results {
              req
                .url_mut()
                .query_pairs_mut()
                .append_pair("includeActionResults", &include_action_results.to_string());
            }
            let req_body = azure_core::EMPTY_BODY;
            req.set_body(req_body);
            Ok(Response(this.client.send(&mut req).await?))
  ...
  pub mod get {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::TestIterationDetailsModel> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::TestIterationDetailsModel =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::TestIterationDetailsModel>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::TestSessionList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::TestSessionList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
      ...
      pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
        Box::pin({
          ...
          async move {
            ...
            if let Some(include_only_completed_sessions) = &this.include_only_completed_sessions {
