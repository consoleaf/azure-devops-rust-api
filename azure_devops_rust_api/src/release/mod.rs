...
pub mod releases {
  ...
  pub mod list {
    ...
    impl RequestBuilder {
      ...
      pub fn min_created_time(mut self, min_created_time: impl Into<time::OffsetDateTime>) -> Self {
        self.min_created_time = Some(min_created_time.into());
        self
      }
      #[doc = "Releases that were created before this time."]
      pub fn max_created_time(mut self, max_created_time: impl Into<time::OffsetDateTime>) -> Self {
        ...
        Box::pin({
          ...
          async move {
            ...
            if let Some(min_created_time) = &this.min_created_time {
              let formatted_date_time = crate::date_time::format_date_time(min_created_time)?;
              req
                .url_mut()
                .query_pairs_mut()
            ...
            if let Some(max_created_time) = &this.max_created_time {
              let formatted_date_time = crate::date_time::format_date_time(max_created_time)?;
              req
                .url_mut()
                .query_pairs_mut()
  ...
  pub mod get_release_environment {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::ReleaseEnvironment> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::ReleaseEnvironment = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
    ...
    impl RequestBuilder {
      ...
      pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
        Box::pin({
          ...
          async move {
            let url = azure_core::Url::parse(&format!(
              "{}/{}/{}/_apis/release/releases/{}/environments/{}/deployPhases/{}/tasks/{}/logs",
              this.client.endpoint(),
              &this.organization,
              &this.project,
              &this.release_id,
              &this.environment_id,
              &this.release_deploy_phase_id,
              &this.task_id
            ))?;
            let mut req = azure_core::Request::new(url, azure_core::Method::Get);
            if let Some(auth_header) = this
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::ReleaseApprovalList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::ReleaseApprovalList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod update {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::ReleaseApproval> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::ReleaseApproval = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
...
pub mod definitions {
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::ReleaseDefinitionList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::ReleaseDefinitionList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
      ...
      pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
        Box::pin({
          ...
          async move {
            ...
            if let Some(search_text_contains_folder_name) = &this.search_text_contains_folder_name {
              req.url_mut().query_pairs_mut().append_pair(
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::ReleaseDefinitionList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod create {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::ReleaseDefinition> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::ReleaseDefinition = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod get_release_definition_history {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::ReleaseDefinitionRevisionList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::ReleaseDefinitionRevisionList =
...
pub mod deployments {
  ...
  pub mod list {
    ...
    impl RequestBuilder {
      ...
      pub fn min_started_time(mut self, min_started_time: impl Into<time::OffsetDateTime>) -> Self {
        self.min_started_time = Some(min_started_time.into());
        self
      }
      pub fn max_started_time(mut self, max_started_time: impl Into<time::OffsetDateTime>) -> Self {
        ...
        Box::pin({
          ...
          async move {
            ...
            if let Some(min_modified_time) = &this.min_modified_time {
              let formatted_date_time = crate::date_time::format_date_time(min_modified_time)?;
              req
                .url_mut()
                .query_pairs_mut()
            ...
            if let Some(max_modified_time) = &this.max_modified_time {
              let formatted_date_time = crate::date_time::format_date_time(max_modified_time)?;
              req
                .url_mut()
                .query_pairs_mut()
            ...
            if let Some(min_started_time) = &this.min_started_time {
              let formatted_date_time = crate::date_time::format_date_time(min_started_time)?;
              req
                .url_mut()
                .query_pairs_mut()
            ...
            if let Some(max_started_time) = &this.max_started_time {
              let formatted_date_time = crate::date_time::format_date_time(max_started_time)?;
              req
                .url_mut()
                .query_pairs_mut()
  ...
  pub mod get_release_task_attachments {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::ReleaseTaskAttachmentList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::ReleaseTaskAttachmentList =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::ReleaseTaskAttachmentList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::ManualInterventionList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::ManualInterventionList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::ManualInterventionList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod get {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::ManualIntervention> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::ManualIntervention = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
