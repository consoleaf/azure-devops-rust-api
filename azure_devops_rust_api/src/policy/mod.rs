  ...
  pub mod get {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::PolicyConfiguration> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::PolicyConfiguration = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::PolicyEvaluationRecordList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::PolicyEvaluationRecordList =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
          ...
          async move {
            ...
            if let Some(include_not_applicable) = &this.include_not_applicable {
              req
                .url_mut()
                .query_pairs_mut()
                .append_pair("includeNotApplicable", &include_not_applicable.to_string());
            }
            if let Some(top) = &this.top {
              req
                .url_mut()
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::PolicyEvaluationRecordList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod get {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::PolicyEvaluationRecord> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::PolicyEvaluationRecord = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::PolicyEvaluationRecord>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
