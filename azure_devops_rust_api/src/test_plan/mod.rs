  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::TestConfigurationList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::TestConfigurationList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::TestConfigurationList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod create {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::TestConfiguration> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::TestConfiguration = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
...
pub mod test_plans {
  ...
  pub mod create {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::TestPlan>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod clone_test_plan {
    ...
    impl Response {
      pub async fn into_body(
        ...
        let bytes = self.0.into_body().collect().await?;
        let body: models::CloneTestPlanOperationInformation = serde_json::from_slice(&bytes)
          .map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
  ...
  pub mod clone_test_suite {
    ...
    impl Response {
      pub async fn into_body(
        ...
        let bytes = self.0.into_body().collect().await?;
        let body: models::CloneTestSuiteOperationInformation = serde_json::from_slice(&bytes)
          .map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
  ...
  pub mod clone_test_case {
    ...
    impl Response {
      pub async fn into_body(
        ...
        let bytes = self.0.into_body().collect().await?;
        let body: models::CloneTestCaseOperationInformation = serde_json::from_slice(&bytes)
          .map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::TestVariableList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::TestVariableList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
