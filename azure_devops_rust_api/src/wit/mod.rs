...
impl Client {
  ...
  pub fn account_my_work_recent_activity_client(&self) -> account_my_work_recent_activity::Client {
  ...
  pub fn comment_reactions_engaged_users_client(&self) -> comment_reactions_engaged_users::Client {
  ...
  pub fn work_item_revisions_discussions_client(&self) -> work_item_revisions_discussions::Client {
...
pub mod classification_nodes {
  ...
  pub mod get_classification_nodes {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::WorkItemClassificationNodeList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::WorkItemClassificationNodeList =
  ...
  pub mod get {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::WorkItemClassificationNode> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::WorkItemClassificationNode =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::WorkItemClassificationNode>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod search_queries {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::QueryHierarchyItemsResult> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::QueryHierarchyItemsResult =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::QueryHierarchyItemsResult>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::QueryHierarchyItemList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::QueryHierarchyItemList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::QueryHierarchyItemList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod get {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::QueryHierarchyItem> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::QueryHierarchyItem = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
...
pub mod recyclebin {
  ...
  pub mod get_deleted_work_items {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::WorkItemDeleteReferenceList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::WorkItemDeleteReferenceList =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
  ...
  pub mod get_deleted_work_item_shallow_references {
    ...
    impl Response {
      pub async fn into_body(
        ...
        let bytes = self.0.into_body().collect().await?;
        let body: models::WorkItemDeleteShallowReferenceList = serde_json::from_slice(&bytes)
          .map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::WorkArtifactLinkList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::WorkArtifactLinkList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::WorkItemIconList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::WorkItemIconList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::WorkItemRelationTypeList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::WorkItemRelationTypeList =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::WorkItemRelationTypeList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod get {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::WorkItemRelationType> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::WorkItemRelationType = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(
        ...
        let bytes = self.0.into_body().collect().await?;
        let body: models::WorkItemNextStateOnTransitionList = serde_json::from_slice(&bytes)
          .map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(
        ...
        let bytes = self.0.into_body().collect().await?;
        let body: models::AccountRecentActivityWorkItemModel2List = serde_json::from_slice(&bytes)
          .map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
  ...
  pub mod query {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::ArtifactUriQueryResult> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::ArtifactUriQueryResult = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::ArtifactUriQueryResult>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod create {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::AttachmentReference> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::AttachmentReference = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::WorkItemFieldList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::WorkItemFieldList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
...
pub mod project_process_migration {
  ...
  pub mod migrate_projects_process {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::ProcessMigrationResultModel> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::ProcessMigrationResultModel =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
...
pub mod reporting_work_item_links {
  ...
  pub mod get {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::ReportingWorkItemLinksBatch> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::ReportingWorkItemLinksBatch =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
        ...
        Box::pin({
          ...
          async move {
            ...
            if let Some(start_date_time) = &this.start_date_time {
              let formatted_date_time = crate::date_time::format_date_time(start_date_time)?;
              req
                .url_mut()
                .query_pairs_mut()
...
pub mod reporting_work_item_revisions {
  ...
  pub mod read_reporting_revisions_get {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::ReportingWorkItemRevisionsBatch> {
        let bytes = self.0.into_body().collect().await?;
      ...
      pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
        Box::pin({
          ...
          async move {
            ...
            if let Some(include_discussion_changes_only) = &this.include_discussion_changes_only {
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::WorkItemTagDefinitionList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::WorkItemTagDefinitionList =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::WorkItemTagDefinitionList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod get {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::WorkItemTagDefinition> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::WorkItemTagDefinition = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::WorkItemTagDefinition>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
...
pub mod work_items {
  ...
  pub mod get_work_item_template {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::WorkItem>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
          ...
          async move {
            ...
            if let Some(suppress_notifications) = &this.suppress_notifications {
              req
                .url_mut()
                .query_pairs_mut()
                .append_pair("suppressNotifications", &suppress_notifications.to_string());
            }
            if let Some(expand) = &this.expand {
              req
                .url_mut()
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::WorkItemUpdateList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::WorkItemUpdateList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::CommentReactionList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::CommentReactionList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod create {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::CommentReaction> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::CommentReaction = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::CommentVersionList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::CommentVersionList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::WorkItemTypeCategoryList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::WorkItemTypeCategoryList =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::WorkItemTypeCategoryList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod get {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::WorkItemTypeCategory> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::WorkItemTypeCategory = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::WorkItemTypeList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::WorkItemTypeList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
...
pub mod work_item_types_field {
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(
        ...
        let bytes = self.0.into_body().collect().await?;
        let body: models::WorkItemTypeFieldWithReferencesList = serde_json::from_slice(&bytes)
          .map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
  ...
  pub mod get {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::WorkItemTypeFieldWithReferences> {
        let bytes = self.0.into_body().collect().await?;
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::WorkItemStateColorList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::WorkItemStateColorList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::WorkItemStateColorList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
...
pub mod templates {
  ...
  pub mod list {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::WorkItemTemplateReferenceList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::WorkItemTemplateReferenceList =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
  ...
  pub mod create {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::WorkItemTemplate> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::WorkItemTemplate = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod query_by_wiql {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::WorkItemQueryResult> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::WorkItemQueryResult = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
