...
pub mod consumers {
  ...
  pub mod get {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::Consumer>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod list_consumer_actions {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::ConsumerActionList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::ConsumerActionList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod query {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::NotificationsQuery> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::NotificationsQuery = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::NotificationList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::NotificationList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod list_event_types {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::EventTypeDescriptorList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::EventTypeDescriptorList =
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::EventTypeDescriptorList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod get_event_type {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::EventTypeDescriptor> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::EventTypeDescriptor = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod query_input_values {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::InputValuesQuery> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::InputValuesQuery = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod query_publishers {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::PublishersQuery> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::PublishersQuery = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::SubscriptionList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::SubscriptionList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod create_subscriptions_query {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::SubscriptionsQuery> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::SubscriptionsQuery = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod get {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::SubscriptionDiagnostics> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::SubscriptionDiagnostics =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::SubscriptionDiagnostics>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
