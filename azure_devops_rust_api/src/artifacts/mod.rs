  ...
  pub mod get_global_permissions {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::GlobalPermissionList> {
        ...
        let body: models::GlobalPermissionList = serde_json::from_slice(&bytes).map_err(|e| {
...
pub mod change_tracking {
  ...
  pub mod get_feed_changes {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::FeedChangesResponse> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::FeedChangesResponse = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod get_feed_change {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::FeedChange>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod get_package_changes {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::PackageChangesResponse> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::PackageChangesResponse = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::PackageChangesResponse>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
...
pub mod feed_recycle_bin {
  ...
  pub mod list {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::FeedList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
...
pub mod feed_management {
  ...
  pub mod get_feed_permissions {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::FeedPermissionList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::FeedPermissionList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
    ...
    impl RequestBuilder {
      ...
      pub fn exclude_inherited_permissions(mut self, exclude_inherited_permissions: bool) -> Self {
      ...
      pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
        Box::pin({
          ...
          async move {
            ...
            if let Some(exclude_inherited_permissions) = &this.exclude_inherited_permissions {
              req.url_mut().query_pairs_mut().append_pair(
  ...
  pub mod create_feed_view {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::FeedView>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
...
pub mod artifact_details {
  ...
  pub mod query_package_metrics {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::PackageMetricsList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::PackageMetricsList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod get_packages {
    ...
    impl RequestBuilder {
      ...
      pub fn normalized_package_name(mut self, normalized_package_name: impl Into<String>) -> Self {
  ...
  pub mod get_package {
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::Package>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod query_package_version_metrics {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::PackageVersionMetricsList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::PackageVersionMetricsList =
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::PackageVersionMetricsList>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod get_package_versions {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::PackageVersionList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::PackageVersionList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod get_package_version_provenance {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::PackageVersionProvenance> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::PackageVersionProvenance =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::PackageVersionProvenance>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
...
pub mod recycle_bin {
  ...
  pub mod empty_recycle_bin {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::OperationReference> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::OperationReference = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod get_recycle_bin_package_versions {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::RecycleBinPackageVersionList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::RecycleBinPackageVersionList =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
  ...
  pub mod get_recycle_bin_package_version {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::RecycleBinPackageVersion> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::RecycleBinPackageVersion =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
    ...
    impl std::future::IntoFuture for RequestBuilder {
      ...
      type IntoFuture =
        futures::future::BoxFuture<'static, azure_core::Result<models::RecycleBinPackageVersion>>;
      #[doc = "Returns a future that sends the request and returns the parsed response body."]
      #[doc = ""]
      #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
      #[doc = ""]
  ...
  pub mod get_retention_policy {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::FeedRetentionPolicy> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::FeedRetentionPolicy = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod create_session {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::SessionResponse> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::SessionResponse = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
