  ...
  pub mod list {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::GroupEntitlementList> {
        ...
        let body: models::GroupEntitlementList = serde_json::from_slice(&bytes).map_err(|e| {
  ...
  pub mod add {
    ...
    impl Response {
      pub async fn into_body(
        ...
        let bytes = self.0.into_body().collect().await?;
        let body: models::GroupEntitlementOperationReference = serde_json::from_slice(&bytes)
          .map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
  ...
  pub mod get {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::GroupEntitlement> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::GroupEntitlement = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod get {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::PagedGraphMemberList> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::PagedGraphMemberList = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
...
pub mod user_entitlements {
  ...
  pub mod add {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::UserEntitlementsPostResponse> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::UserEntitlementsPostResponse =
  ...
  pub mod update_user_entitlements {
    ...
    impl Response {
      pub async fn into_body(
        ...
        let bytes = self.0.into_body().collect().await?;
        let body: models::UserEntitlementOperationReference = serde_json::from_slice(&bytes)
          .map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
      ...
      pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
        Box::pin({
          ...
          async move {
            ...
            req.insert_header("content-type", "application/json-patch+json");
            let req_body = azure_core::to_json(&this.body)?;
            if let Some(do_not_send_invite_for_new_users) = &this.do_not_send_invite_for_new_users {
              req.url_mut().query_pairs_mut().append_pair(
  ...
  pub mod get {
    ...
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::UserEntitlement> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::UserEntitlement = serde_json::from_slice(&bytes).map_err(|e| {
          azure_core::error::Error::full(
            azure_core::error::ErrorKind::DataConversion,
            e,
            format!(
  ...
  pub mod update_user_entitlement {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
      pub async fn into_body(self) -> azure_core::Result<models::UserEntitlementsPatchResponse> {
        let bytes = self.0.into_body().collect().await?;
        let body: models::UserEntitlementsPatchResponse =
          serde_json::from_slice(&bytes).map_err(|e| {
            azure_core::error::Error::full(
              azure_core::error::ErrorKind::DataConversion,
              e,
